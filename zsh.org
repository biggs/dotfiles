...
#+STARTUP: overview
#+PROPERTY: header-args:sh :tangle tangled/zsh/.zshrc
...
Most of it's interesting functionality is in the oh-my-zsh/lib folder.
...
- [[https://github.com/robbyrussell/oh-my-zsh/tree/master/plugins/z][fasd]] :: a clever script that stores recently used directories that can then be skipped to
...
2. Press ctrl-z in the terminal to foreground process, so can switch in and out
